...
import SignalFlow from './pages/SignalFlow';      // ← NUEVO
...
export default function App() {
  ...
  function renderView() {
    switch (activeView) {
      ...
      case 'signalflow':     return <SignalFlow       {...sharedProps} />;   // ← NUEVO
      case 'dashboard':
      default:               return <Dashboard        {...sharedProps} />;
    }
  }

  // Signal Flow ocupa toda la pantalla sin el wrapper habitual
  const isFullscreen = activeView === 'signalflow';
  ...
  return (
      <>
        ...
        *, *::before, *::after { box-sizing: border-box; }
        ...
        @media (min-width: 1024px) { .app-inner { padding: 2rem 2.5rem 4rem; } }
        ...
        @media (min-width:1024px) {
          .app-header { flex-direction: row; justify-content: space-between; align-items: flex-start; }
        }
        .app-header-eyebrow {
          font-size: 0.65rem; text-transform: uppercase; letter-spacing: 0.1em;
          color: rgba(255,255,255,0.3); font-weight: 500; margin-bottom: 0.35rem;
        }
        .app-header-title {
          font-family: 'Syne', sans-serif; font-weight: 800;
          font-size: clamp(2rem, 4vw, 2.75rem); color: #fff;
          letter-spacing: -0.04em; line-height: 1.05; margin: 0 0 0.4rem;
        }
        .app-header-sub { font-size: 0.82rem; color: rgba(255,255,255,0.35); font-weight: 300; }
        .app-user-card {
        ...
        .app-user-card:hover { transform: translateY(-2px); box-shadow: 0 8px 32px rgba(0,0,0,0.3); }
        .app-user-label { font-size: 0.62rem; text-transform: uppercase; letter-spacing: 0.1em; color: rgba(255,255,255,0.28); }
        .app-user-name {
        ...
        .app-user-logout {
          ...
          color: #a89eff; cursor: pointer; text-align: left;
        ...
        .app-view { animation: viewIn 0.3s ease both; }
        @keyframes viewIn {
      ...
      `}</style>
        ...
        <div className="app-shell">
          ...
          <main className="app-main">
            {isFullscreen ? (
                /* Signal Flow ocupa todo el espacio disponible sin padding de página */
                <div className="app-inner-full">
                  <div className="app-view" key={activeView} style={{ flex:1, display:'flex', flexDirection:'column', minHeight:0 }}>
                    {renderView()}
                  </div>
                </div>
            ) : (
